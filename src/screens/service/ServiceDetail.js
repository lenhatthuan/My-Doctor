...
const ServiceDetail = (props) => {
    ...
    useEffect(() => {
      ...
      const onBack = () => {
        //props.navigation.goBack();
        (registration.status === "CREATED")? props.navigation.navigate("created"): 
        (registration.status === "PENDDING")? props.navigation.navigate("pendding"): 
        (registration.status === "COMFIRMED")? props.navigation.navigate("confirmed"): 
        (registration.status === "CANCEL")? props.navigation.navigate("cancel"): 
         props.navigation.navigate("expired");
