...
function HeathyNavigator () {
    return (
        ...
        >
          <Stack.Screen name="FollowHeathy" component={FollowHeathyScreen}  options = {{
            headerShown: false
          }}/>
          <Stack.Screen name="BMIHistory" component={HistoryBMIComponent} options = {{
            headerShown: false
          }}/>
          <Stack.Screen name="BMI" component={BMIComponent} options = {{
            headerShown: false
          }}/>
          <Stack.Screen name="ListBMI" component={ListBMIComponent} options = {{
            headerShown: false
          }}/>
          <Stack.Screen name="ListHeart" component={ListHeartComponent} options = {{
            headerShown: false
          }}/>
          <Stack.Screen name="HeartHistory" component={HistoryHeartComponent} options = {{
            headerShown: false
          }}/>
        </Stack.Navigator>
      );
