...
const Department = () => (
    ...
    >
        <Stack.Screen name = "ScheduleDepartment" options={{headerShown: false}} component={ScheduleDepartmentScreen}/>
        <Stack.Screen name = "BookingDepartment" options={{headerShown: false}} component={BookingDepartmentScreen}/>
    </Stack.Navigator>
)
