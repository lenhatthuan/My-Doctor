...
const DateHistory = (props) =>{
    ...
    let BMI = {id: props.id, tall: props.tall, weigh: props.weigh, updatedAt: props.date};
    ...
    return (
        ...
        <Pressable style = {styles.main} onPress={() => {setIsEdit(true)}}> 
            ...
            <EditBMI visible = {isEdit} onCancel = {onCancel} onDelete = {onDelete} BMI = {BMI} update = {update}/>
        </Pressable>
    )
}
