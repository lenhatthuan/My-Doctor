...
import { View, StyleSheet, Text, Pressable, AsyncStorage, Image } from "react-native";
  ...
  return (
    <>
      ...
      <View style = {styles.component}>
          ...
          <View style = {styles.main}><Image  source = {require('../../../assets/imgs/loadingHeathy.gif')}/></View>
